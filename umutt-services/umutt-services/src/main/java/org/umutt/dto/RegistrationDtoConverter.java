...
public class RegistrationDtoConverter {
  ...
  public static void fromJson(JsonObject json, RegistrationDto obj) {
    ...
    if (json.getValue("subscribeForUpdates") instanceof Boolean) {
        obj.setSubscribeForUpdates((Boolean)json.getValue("subscribeForUpdates"));
      }
  ...
  public static void toJson(RegistrationDto obj, JsonObject json) {
    ...
    if (null != obj.getSubscribeForUpdates()) {
        json.put("subscribeForUpdates", obj.getSubscribeForUpdates());
      }
