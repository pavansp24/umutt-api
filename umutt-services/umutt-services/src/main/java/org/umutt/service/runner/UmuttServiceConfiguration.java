...
@Configuration
@ComponentScan("org.umutt")
@EnableJpaRepositories(basePackages={"org.umutt"})
@PropertySource(value={"classpath:application.properties"})
@EnableAspectJAutoProxy
public class UmuttServiceConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource) {
		...
		entityManagerFactoryBean.setPackagesToScan("org.umutt");
